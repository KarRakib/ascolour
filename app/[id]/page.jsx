...
const ProductDetails = () => {
    ...
    const handleProductCart = ({ products }) => {
        const product = { id: products.id, title: products.title, price: products.price, quantity, size: selectedSize, color: selectedColor }
    }
    if (!findProduct) {
        return <div>Product not found</div>; // Or any other fallback UI
    }
    const { category, colors, coreRange, description, images, price, productCode, sizes, title, _id } = findProduct;
                        ...
                        <div className="w-full md:w-1/2 px-4">
                            ...
                            <div className="mb-6">
                                ...
                                <form action="#">
                                    ...
                                    <button onClick={Inecrease} type="button" className="px-5 py-2 border text-xl font-semibold bg-gray-200 rounded-md">+</button>
                                </form>
